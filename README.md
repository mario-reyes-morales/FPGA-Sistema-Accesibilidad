...
Proyecto académico realizado en equipo como parte de la asignatura de Programación Hardware Reconfigurable. Mario Reyes Morales actuó como responsable de coordinación y liderazgo del equipo. El trabajo se realizó de forma colaborativa, con una carga de trabajo aproximadamente equilibrada entre los participantes.
